...
public:
    ...
    QObject(parent)
  {
    ...
    descriptions["btmode"] = tr("Bluetooth Mode (-1=Uninit, 0-Disable, 1-Head, 2-Receive, 3-Scanner, 4-Gamepad)");
    ...
    descriptions["gyrox"] = tr("Raw Sensor Gyro X(dps)");
    descriptions["gyroy"] = tr("Raw Sensor Gyro Y(dps)");
    descriptions["gyroz"] = tr("Raw Sensor Gyro Z(dps)");
    descriptions["accx"] = tr("Raw Sensor Accel X(g)");
    descriptions["accy"] = tr("Raw Sensor Accel Y(g)");
    descriptions["accz"] = tr("Raw Sensor Accel Z(g)");
    descriptions["off_magx"] = tr("Calibrated Mag X(uT)");
    descriptions["off_magy"] = tr("Calibrated Mag Y(uT)");
    descriptions["off_magz"] = tr("Calibrated Mag Z(uT)");
    descriptions["off_gyrox"] = tr("Calibrated Gyro X(dps)");
    descriptions["off_gyroy"] = tr("Calibrated Gyro Y(dps)");
    descriptions["off_gyroz"] = tr("Calibrated Gyro Z(dps)");
    descriptions["off_accx"] = tr("Calibrated Accel X(g)");
    descriptions["off_accy"] = tr("Calibrated Accel Y(g)");
    descriptions["off_accz"] = tr("Calibrated Accel Z(g)");
